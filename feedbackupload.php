...
if(isset($_POST['submit'])){
    ...
    $sql="insert into `feedback` (name,email,subject,date,feedback)
    values ('$name','$email', '$subject','$date','$feedback')";
    $result=mysqli_query($con,$sql);
    if($result)
    {
        
        echo "<script>alert('Your Feedback Enter to the Upcoming  List '); window.location.href = 'feedbackdashboard.php';</script>";
        // echo "Successfull";
    } else {
          ...
          <div class="formcard">
            ...
            <h1 class="formhead"><b>Dreamers Feedback</b></h1><br>
             ...
             <div style="font-size: larger;" >
                ...
                <input type="text" class="formfiltext" placeholder="Name" name="name" autocomplete="off">
            </div>
            ...
            <div>
                ...
                <input type="text" class="formfiltext" placeholder="Subject" name="subject" autocomplete="off">
            </div>
            ...
            <div>
                ...
                <textarea class="formfildes" name="feedback" rows="5" placeholder="Feedback"></textarea>
            </div>
