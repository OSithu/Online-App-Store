...
if(isset($_POST['submit'])){
    ...
    $sql="update `movie` set moviename='$moviename',
    moviedescription='$moviedescription', imdb='$imdb',
    movieimg='$movieimg', email='$email' where movieid=$movieid";
    $result=mysqli_query($con,$sql); 
    if($result)
    {
          ...
          <div class="formcard">
            ...
            <h1 class="formhead"><b>Upload Your Dream Movie</b></h1><br>
             ...
             <div style="font-size: larger;" >
                ...
                <input type="text" class="formfiltext"  name="moviename" autocomplete="off" value="<?php echo $moviename?>">
            </div>
            ...
            <div>
                ...
                <textarea class="formfildes" name="moviedescription" rows="5" value="<?php echo $moviedescription?>" ></textarea>
            </div>
            ...
            <div>
                ...
                <input type="text" class="formfiltext" placeholder="Imdb" name="imdb" autocomplete="off" value="<?php echo $imdb?>">
            </div>
            <br>
