...
if(isset($_POST['submit'])){
    ...
    $sql="update `cruds` set id='$id',fname='$fname',
    ...
    <h1 class="formhead"><b>Create Account</b></h1><br>
        <form  method="POST" >
            ...
            <div >
                ...
                <input type="text"  class="formfiltext" placeholder="First Name" name="fname" autocomplete="off" value="<?php echo $fname;?>" >
            </div>
            ...
            <div >
                ...
                <input type="text"  class="formfiltext" placeholder="Last Name" name="lname" autocomplete="off" value="<?php echo $lname;?>">
            </div>
            ...
            <div >
                ...
                <input type="email"  class="formfiltext" placeholder="E-mail" name="email" autocomplete="off" value="<?php echo $email;?>">
            </div>
