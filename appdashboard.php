...
<body>
    ...
    <div >
      <div >
        <h2 class="formhead">Upcoming Apps</h2>
      </div>
   ...
   if (isset($_SESSION['email']))
 {
   ...
   $sql="Select * from `app` where email='$x'";
...
if($result){   
    ...
    <tr >
        ...
        <td> <?php echo $row['appdescription']; ?> </td>
        <td> <?php echo $row['email']; ?> </td>
        <td> <?php
         
         
         echo '<a href="appupdate.php?
         updateappid='.$appid.'"><button  style="color:white; background-color:blue; width:90px; height:50px; border-radius:8px; cursor: pointer;border: none;font-size: 100%; margin-left:10px;  ">Edit</button></a>';
         echo '<a href="appdelete.php?
         deleteappid='.$appid.'"><button  style="color:white; background-color:red; width:90px; height:50px; border-radius:8px; cursor: pointer;border: none;font-size: 100%; margin-left:10px;  ">Remove</button></a>';
